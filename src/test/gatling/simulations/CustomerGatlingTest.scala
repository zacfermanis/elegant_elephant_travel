...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "displayFull":"SAMPLE_TEXT", "displayFirst":"SAMPLE_TEXT", "salutation":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "phoneNumber":"SAMPLE_TEXT", "dateOfBirth":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
