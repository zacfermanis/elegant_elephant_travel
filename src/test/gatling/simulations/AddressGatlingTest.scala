...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "streetAddress1":"SAMPLE_TEXT", "streetAddress2":"SAMPLE_TEXT", "postalCode":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "country":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
