...
class ContactRequestGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ContactRequest entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "contactPhone":"SAMPLE_TEXT", "preferredContactMethod":"SAMPLE_TEXT", "requestDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
